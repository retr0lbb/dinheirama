          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-sm text-apple_green w-full text-right pr-4">
                <Link className="underline hover:text-apple_green/80 transition-all" href={"#"}>Esqueci minha senha.</Link>
              </p>
            </div>
            ...
            <div className="grid place-items-center gap-2 px-4">
              ...
              <span className="text-snow-600 mt-2">
                Não tem uma conta? <Link className="underline text-apple_green hover:text-apple_green/80 transition-all" href={"/register"}>Cadastre-se</Link>
              </span>
            </div>
          </form>

    ...
    return(
        <li className="relative group">
            <a  href="" className={navlinkVariant({isActive, className})}>
                <Icon   
                  size={28} 
                  className={!isActive? "text-snow-600 group-hover:text-apple_green transition-all": "text-snow-200"} 
                />
                <p className={!isActive? "text-snow-400 group-hover:text-apple_green transition-all": "text-snow-200"}>{title}</p>
            </a>
        </li>
    )
}
